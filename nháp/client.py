...
def RegistrationPage():
    ...
    but_backToLogin = tk.Button(
        registrationPage, text="Back to login", width=10, command=back_to_login)
...
def Search():  # Dùng socket để chỉnh
    ...
    # try:
    request = "Search"
    client.sendall(request.encode('utf8'))  # gửi request
    print(client.recv(1024).decode('utf8'))  # Nhận accept
